...
#
group :development do
  # gem 'spree_scaffold', path: 'spree_scaffold_4.2'
  gem 'spree_scaffold', github: 'shivareddy547/spree_scaffold_4.2'
end

# gem 'spree_admin_roles_and_access', path: 'spree_admin_roles_and_access'

gem 'spree_admin_roles_and_access', github: 'shivareddy547/spree_admin_roles_and_access_4.2'
